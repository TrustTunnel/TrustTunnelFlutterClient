...
const kWindowEventWillEnterFullScreen = 'will-enter-full-screen';
const kWindowEventWillLeaveFullScreen = 'will-exit-full-screen';
...
class WindowManager {
  ...
  Future<void> _methodCallHandler(MethodCall call) async {
    for (final WindowListener listener in listeners) {
      ...
      Map<String, Function> funcMap = {
        ...
        kWindowEventWillEnterFullScreen: listener.onWindowWillEnterFullScreen,
        kWindowEventWillLeaveFullScreen: listener.onWindowWillLeaveFullScreen,
      };
  ...
  /// Hides the window.
  /// hideFromDock is optional and for MacOS only
  Future<void> hide({bool hideFromDock = false}) async {
    final Map<String, dynamic> arguments = {
      'hideFromDock': hideFromDock,
    };
    await _channel.invokeMethod('hide', arguments);
  }
  ...
  Future<void> setHideTitleBarOnExitFullScreen(bool hide) async {
    final Map<String, dynamic> arguments = {
      "hideTitleBarOnExitFullScreen": hide,
    };
    await _channel.invokeMethod('setHideTitleBarOnExitFullScreen', arguments);
  }
