...
public class WindowManagerPlugin: NSObject, FlutterPlugin, NSApplicationDelegate {
    ...
    public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
        ...
        case "startDragging":
            ...
            result(true)
            break
        case "setHideTitleBarOnExitFullScreen": 
            windowManager.setHideTitleBarOnExitFullScreen(args)
            result(true)
            break
        default:
