...
public class WindowManager: NSObject, NSWindowDelegate {
    ...
    private var _hideTitleBarOnExitFullScreen: Bool = false
    ...
    public func setHideTitleBarOnExitFullScreen(_ args: [String: Any]) {
        _hideTitleBarOnExitFullScreen = args["hideTitleBarOnExitFullScreen"] as! Bool
    }
    ...
    public func hide(_ args: [String: Any]) {
        let hideFromDock = args["hideFromDock"] as! Bool
        DispatchQueue.main.async {
            if(hideFromDock) {
    ...
    public func windowWillEnterFullScreen(_ notification: Notification) {
        _emitEvent("will-enter-full-screen");
    }
    
    public func windowWillExitFullScreen(_ notification: Notification) {
        if(_hideTitleBarOnExitFullScreen){
            mainWindow.titleVisibility = .hidden
            mainWindow.titlebarAppearsTransparent = true
        }
        _emitEvent("will-exit-full-screen");
    }
